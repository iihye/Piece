...
export const useUserStore = defineStore(
  ...
  () => {
    ...
    const checkMypageLabelList = () => {
      axios
        .get(`${import.meta.env.VITE_REST_PIECE_API}/mylabels/check`)
    ...
    const findMypageLabelList = () => {
      axios
        .get(`${import.meta.env.VITE_REST_PIECE_API}/mylabels`)
        .then((res) => {
    ...
    const addMypageLabelWear = (labelId) => {
      axios
        .put(`${import.meta.env.VITE_REST_PIECE_API}/mylabels/${labelId}`)
        .then(() => {
          findMypageLabelList();
    ...
    const deleteMypageLabelWear = () => {
      axios
        .put(`${import.meta.env.VITE_REST_PIECE_API}/mylabels/wearoff`)
        .then(() => {
          findMypageLabelList();
          commonStore.findLoginUserInfo();
        })
    ...
    const changeMypageNickname = (userId, nickname) => {
      axios
        .put(`${import.meta.env.VITE_REST_USER_API}/users/${userId}/nickname`, {
    ...
    const changeMypagePassword = (userId, password) => {
      axios
        .put(`${import.meta.env.VITE_REST_USER_API}/users/${userId}/password`, {
    ...
    const checkTutorial = () => {
      axios
        .put(`${import.meta.env.VITE_REST_USER_API}/users/tutorial`)
        .catch((err) => {});
    };
