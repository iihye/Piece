...
<template>
    <div class="profile-img-view">
        <div class="title">프로필 이미지를 등록해주세요</div>
        <div class="content">나를 표현하는 프로필 이미지를 등록해주세요</div>
        <div v-if="imageUrl">
        ...
        <UploadButton @uploadSuccess="handleSuccess" @uploadError="handleError" />
    </div>
</template>
